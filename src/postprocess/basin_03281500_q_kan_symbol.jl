...
function check_fit_plot(tmp_func, params, input, target; title = "", figsize = (400, 400))
	...
	annotate!([(annote_pos..., Plots.text("R² = $(round(r2, digits=2))", 16, "Times", :right, :bottom, color=:black))])
...
function plot_q_symbolize_fit()
	...
	# Layer 1 plots
	fig112 = check_fit_plot(q_func_112, params_112, q_input[1, :], qnn_layer1_postacts_arr[:, 2, 1], title = "𝛷(1,1,2)", figsize = (300, 300))
	...
	fig132 = check_fit_plot(q_func_132, params_132, q_input[3, :], qnn_layer1_postacts_arr[:, 2, 3], title = "𝛷(1,3,2)", figsize = (300, 300))
	...
	# Combine plots
	layer1_plot = plot(fig112, fig121, fig122, fig132, fig123, layout = (1, 5), size = (1500, 300))
	layer2_plot = plot(fig211, fig221, fig231, layout = (1, 3), size = (900, 300))
