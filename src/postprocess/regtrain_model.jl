...
model_name = "k50_pro_2(reg)"
basemodel_name = "exphydro_pro_2(disc)" # exphydro_pro_1 exphydro_pro_2
...
for basin_id in ["02361000", "03281500", "06191500"]
	...
	opt_et_ps, etnn_loss_recorder = train_NN(
		...
		optmzr = ADAM(0.01), max_N_iter = 2000, loss_func = mse_loss, reg_func = reg_loss(5e-3),
	)
	...
	opt_ps, val_opt_ps, loss_recorder = train_with_valv2(
		...
		loss_func = loss_func, max_N_iter = 200, warm_up = 1,  reg_func = reg_loss(0.05),
