...
# set data directory
project_path = "E:\\JlCode\\HydroPaperCodes\\src\\project\\v0"
...
train_stop_date = Date(2001,09,30)
test_start_date = Date(2001,10,01)
...
include("HydroNODE_data.jl")
include("HydroNODE_models.jl")
include("HydroNODE_training.jl")
